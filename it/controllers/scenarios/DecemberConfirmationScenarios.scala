...
object DecemberConfirmationScenarios
    extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants with ITCoreTestData {

  val decemberVariableFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Variable Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-05".toLocalDate, "2020-12-02".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-02".toLocalDate)
            ),
            PartialPeriod(
              Period("2020-12-03".toLocalDate, "2020-12-30".toLocalDate),
              Period("2020-12-03".toLocalDate, "2020-12-28".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-12-30".toLocalDate, "2021-01-26".toLocalDate),
  ...
  val decemberVariableMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Variable Monthly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val decemberVariableTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Variable Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              ...
              Period("2020-12-13".toLocalDate, "2020-12-14".toLocalDate)
            ),
        ...
        .withUsualHours(
          List(
            UsualHours("2020-12-14".toLocalDate, Hours(40.0)),
            UsualHours("2020-12-28".toLocalDate, Hours(50.0)),
            UsualHours("2021-01-11".toLocalDate, Hours(50.0))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2020-12-14".toLocalDate, Hours(14.0)),
            PartTimeHours("2020-12-28".toLocalDate, Hours(15.0)),
            PartTimeHours("2021-01-11".toLocalDate, Hours(15.0))
          )
        )
        -> 1081.91,
      emptyUserAnswers
  ...
  val decemberVariableWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Variable Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-12-01".toLocalDate, "2020-12-07".toLocalDate),
  ...
  val decemberWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Fixed Weekly Scenarios" -> Seq(
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2020-12-01".toLocalDate, "2020-12-07".toLocalDate)),
            FullPeriod(Period("2020-12-08".toLocalDate, "2020-12-14".toLocalDate)),
        ...
        .withUsualHours(
          List(
            UsualHours("2020-12-07".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-14".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-21".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-28".toLocalDate, Hours(37.0)),
            UsualHours("2021-01-04".toLocalDate, Hours(15.86))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2020-12-07".toLocalDate, Hours(10.0)),
            PartTimeHours("2020-12-14".toLocalDate, Hours(12.0)),
            PartTimeHours("2020-12-21".toLocalDate, Hours(10.0)),
            PartTimeHours("2020-12-28".toLocalDate, Hours(15.0)),
            PartTimeHours("2021-01-04".toLocalDate, Hours(1.06))
          )
        )
        -> 1502.24,
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-12-04".toLocalDate, "2020-12-10".toLocalDate),
            ...
            PartialPeriod(
              Period("2020-12-25".toLocalDate, "2020-12-31".toLocalDate),
        ...
        .withUsualHours(
          List(
            UsualHours("2020-12-10".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-17".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-24".toLocalDate, Hours(37.0)),
            UsualHours("2020-12-31".toLocalDate, Hours(37.0))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2020-12-10".toLocalDate, Hours(10.0)),
            PartTimeHours("2020-12-17".toLocalDate, Hours(12.0)),
            PartTimeHours("2020-12-24".toLocalDate, Hours(10.0)),
            PartTimeHours("2020-12-31".toLocalDate, Hours(15.0))
          )
        )
        -> 1344.84,
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            ...
            PartialPeriod(
              Period("2020-12-25".toLocalDate, "2020-12-31".toLocalDate),
              Period("2020-12-25".toLocalDate, "2020-12-27".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2020-12-01".toLocalDate, "2020-12-07".toLocalDate)),
            PartialPeriod(
              Period("2020-12-08".toLocalDate, "2020-12-14".toLocalDate),
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-26".toLocalDate, "2020-12-02".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-02".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-29".toLocalDate, "2020-12-05".toLocalDate),
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-25".toLocalDate, "2020-12-01".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-01".toLocalDate)
            )
          )
        )
  ...
  val decemberTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Fixed Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughOngoing)
        .withPaymentFrequency(FortNightly)
        .withClaimPeriodStart("2020-12-01")
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2020-12-01".toLocalDate, "2020-12-14".toLocalDate)),
            FullPeriod(Period("2020-12-15".toLocalDate, "2020-12-28".toLocalDate)),
            PartialPeriod(
              Period("2020-12-29".toLocalDate, "2021-01-11".toLocalDate),
              Period("2020-12-29".toLocalDate, "2020-12-31".toLocalDate)
        ...
        .withUsualHours(
          List(
            UsualHours("2020-12-14".toLocalDate, Hours(98.0)),
            UsualHours("2020-12-28".toLocalDate, Hours(98.0)),
            UsualHours("2021-01-11".toLocalDate, Hours(21.0))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2020-12-14".toLocalDate, Hours(48.0)),
            PartTimeHours("2020-12-28".toLocalDate, Hours(48.0)),
            PartTimeHours("2021-01-11".toLocalDate, Hours(6.0))
          )
        )
        -> 610.19,
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              ...
              Period("2020-12-03".toLocalDate, "2020-12-11".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-12-28".toLocalDate, "2021-01-10".toLocalDate),
              Period("2020-12-29".toLocalDate, "2020-12-31".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-19".toLocalDate, "2020-12-02".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-02".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-22".toLocalDate, "2020-12-05".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-02".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-23".toLocalDate, "2020-12-06".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-01".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-18".toLocalDate, "2020-12-01".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-01".toLocalDate)
            ),
            PartialPeriod(
              Period("2020-12-02".toLocalDate, "2020-12-15".toLocalDate),
  ...
  val decemberMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Fixed Monthly Scenarios" -> Seq(
      emptyUserAnswers
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-12-01".toLocalDate, "2020-12-31".toLocalDate),
              Period("2020-12-05".toLocalDate, "2020-12-21".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-03".toLocalDate, "2020-12-02".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-02".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-09".toLocalDate, "2020-12-08".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-01".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020-11-02".toLocalDate, "2020-12-01".toLocalDate),
              Period("2020-12-01".toLocalDate, "2020-12-01".toLocalDate)
            ),
            PartialPeriod(
              Period("2020-12-02".toLocalDate, "2021-01-01".toLocalDate),
              Period("2020-12-02".toLocalDate, "2020-12-02".toLocalDate)
            )
          )
        )
  ...
  val decemberFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "December Fixed Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withRegularLengthEmployed(RegularLengthEmployed.Yes)
        .withFurloughStatus(FurloughStatus.FurloughEnded)
