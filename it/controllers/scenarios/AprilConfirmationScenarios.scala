...
object AprilConfirmationScenarios
    extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants with ITCoreTestData {
  val aprilVariableWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Variable Weekly Scenarios" -> Seq(
      emptyUserAnswers
  ...
  val aprilVariableTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Variable Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
        ...
        .withPartTimePeriods(
          List(
            ...
            PartialPeriod(
              ...
              Period("2021-04-29".toLocalDate, "2021-04-30".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Variable)
  ...
  val aprilVariableMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Variable Monthly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val aprilVariableFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Variable Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-03-05".toLocalDate, "2021-04-01".toLocalDate),
              Period("2021-04-01".toLocalDate, "2021-04-01".toLocalDate)
            ),
            PartialPeriod(
              Period("2021-04-02".toLocalDate, "2021-04-29".toLocalDate),
  ...
  val aprilWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Fixed Weekly Scenarios" -> Seq(
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            ...
            FullPeriod(Period("2021-04-08".toLocalDate, "2021-04-14".toLocalDate)),
            FullPeriod(Period("2021-04-15".toLocalDate, "2021-04-21".toLocalDate)),
            FullPeriod(Period("2021-04-22".toLocalDate, "2021-04-28".toLocalDate)),
            PartialPeriod(
        ...
        .withUsualHours(
          List(
            UsualHours("2021-04-07".toLocalDate, Hours(37.0)),
            UsualHours("2021-04-14".toLocalDate, Hours(37.0)),
            UsualHours("2021-04-21".toLocalDate, Hours(37.0)),
            UsualHours("2021-04-28".toLocalDate, Hours(37.0)),
            UsualHours("2021-05-05".toLocalDate, Hours(15.86))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2021-04-07".toLocalDate, Hours(10.0)),
            PartTimeHours("2021-04-14".toLocalDate, Hours(12.0)),
            PartTimeHours("2021-04-21".toLocalDate, Hours(10.0)),
            PartTimeHours("2021-04-28".toLocalDate, Hours(15.0)),
            PartTimeHours("2021-05-05".toLocalDate, Hours(1.06))
          )
        )
        -> 1438.26,
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-04".toLocalDate, "2021-04-10".toLocalDate),
              Period("2021-04-06".toLocalDate, "2021-04-10".toLocalDate)
            ),
            PartialPeriod(
              Period("2021-04-25".toLocalDate, "2021-05-01".toLocalDate),
              Period("2021-04-25".toLocalDate, "2021-04-27".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2021-04-01".toLocalDate, "2021-04-07".toLocalDate)),
            PartialPeriod(
              Period("2021-04-08".toLocalDate, "2021-04-14".toLocalDate),
              Period("2021-04-08".toLocalDate, "2021-04-08".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
  ...
  val aprilTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Fixed Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughOngoing)
        .withPaymentFrequency(FortNightly)
        .withClaimPeriodStart("2021-04-01")
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2021-04-01".toLocalDate, "2021-04-14".toLocalDate)),
            FullPeriod(Period("2021-04-15".toLocalDate, "2021-04-28".toLocalDate)),
            PartialPeriod(
              Period("2021-04-29".toLocalDate, "2021-05-12".toLocalDate),
              Period("2021-04-29".toLocalDate, "2021-04-30".toLocalDate)
        ...
        .withUsualHours(
          List(
            UsualHours("2021-04-14".toLocalDate, Hours(98.0)),
            UsualHours("2021-04-28".toLocalDate, Hours(98.0)),
            UsualHours("2021-05-12".toLocalDate, Hours(21.0))
          )
        )
        .withPartTimeHours(
          List(
            PartTimeHours("2021-04-14".toLocalDate, Hours(48.0)),
            PartTimeHours("2021-04-28".toLocalDate, Hours(48.0)),
            PartTimeHours("2021-05-12".toLocalDate, Hours(6.0))
          )
        )
        -> 583.66,
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              ...
              Period("2021-04-03".toLocalDate, "2021-04-11".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-28".toLocalDate, "2021-05-11".toLocalDate),
              Period("2021-04-29".toLocalDate, "2021-04-30".toLocalDate)
            )
          )
        )
  ...
  val aprilMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Fixed Monthly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughOngoing)
        .withPaymentFrequency(Monthly)
        .withClaimPeriodStart("2021-04-01")
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-01".toLocalDate, "2021-04-30".toLocalDate),
              Period("2021-04-05".toLocalDate, "2021-04-21".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-01".toLocalDate, "2021-04-30".toLocalDate),
              Period("2021-04-02".toLocalDate, "2021-04-11".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-01".toLocalDate, "2021-04-30".toLocalDate),
              Period("2021-04-02".toLocalDate, "2021-04-20".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              ...
              Period("2021-04-01".toLocalDate, "2021-04-25".toLocalDate)
            ),
            PartialPeriod(
              Period("2021-04-26".toLocalDate, "2021-05-25".toLocalDate),
              Period("2021-04-26".toLocalDate, "2021-04-30".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
  ...
  val aprilFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "April Fixed Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
        .withFurloughEndDate("2021-04-28")
        .withPaymentFrequency(FourWeekly)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2021-04-01".toLocalDate, "2021-04-28".toLocalDate)),
            PartialPeriod(
              Period("2021-04-29".toLocalDate, "2021-05-26".toLocalDate),
              Period("2021-04-29".toLocalDate, "2021-04-30".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-30".toLocalDate, "2021-05-27".toLocalDate),
              Period("2021-04-30".toLocalDate, "2021-04-30".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2021-04-29".toLocalDate, "2021-05-26".toLocalDate),
              Period("2021-04-29".toLocalDate, "2021-04-29".toLocalDate)
            )
          )
        )
        .withPayMethod(PayMethod.Regular)
