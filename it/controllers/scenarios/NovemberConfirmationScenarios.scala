...
object NovemberConfirmationScenarios
    extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants with ITCoreTestData {

  val novemberVariableWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Variable Weekly Scenarios" -> Seq(
      emptyUserAnswers
  ...
  val novemberVariableTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Variable Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withFurloughStatus(FurloughStatus.FurloughEnded)
  ...
  val novemberVariableMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Variable Monthly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
  ...
  val novemberVariableFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Variable Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020, 10, 5".toLocalDate, "2020, 11, 1".toLocalDate),
              Period("2020, 11, 1".toLocalDate, "2020, 11, 1".toLocalDate)
            ),
            PartialPeriod(
              Period("2020, 11, 2".toLocalDate, "2020, 11, 29".toLocalDate),
  ...
  val novemberWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Fixed Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            ...
            PartialPeriod(
              Period("2020, 11, 4".toLocalDate, "2020, 11, 10".toLocalDate),
              Period("2020, 11, 6".toLocalDate, "2020, 11, 10".toLocalDate)
            ),
            PartialPeriod(
              Period("2020, 11, 25".toLocalDate, "2020, 12, 1".toLocalDate),
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            ...
            FullPeriod(Period("2020, 11, 22".toLocalDate, "2020, 11, 28".toLocalDate)),
            PartialPeriod(
              Period("2020, 11, 29".toLocalDate, "2020, 12, 5".toLocalDate),
              Period("2020, 11, 29".toLocalDate, "2020, 11, 30".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2020, 11, 1".toLocalDate, "2020, 11, 7".toLocalDate)),
            PartialPeriod(
              Period("2020, 11, 8".toLocalDate, "2020, 11, 14".toLocalDate),
  ...
  val novemberTwoWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Fixed Two Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020, 10, 29".toLocalDate, "2020, 11, 11".toLocalDate),
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020, 11, 28".toLocalDate, "2020, 12, 11".toLocalDate),
              Period("2020, 11, 29".toLocalDate, "2020, 11, 30".toLocalDate)
            )
          )
        )
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            PartialPeriod(
              Period("2020, 11, 1".toLocalDate, "2020, 11, 14".toLocalDate),
  ...
  val novemberMonthlyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Fixed Monthly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
  ...
  val novemberFourWeeklyScenarios: Seq[(String, Seq[(UserAnswers, BigDecimal)])] = Seq(
    "November Fixed Four Weekly Scenarios" -> Seq(
      emptyUserAnswers
        .withClaimPeriodStart("2020, 11, 1")
        .withClaimPeriodEnd("2020, 11, 30")
        .withFurloughStartDate("2020, 11, 1")
      ...
      emptyUserAnswers
        ...
        .withPartTimePeriods(
          List(
            FullPeriod(Period("2020, 11, 1".toLocalDate, "2020, 11, 28".toLocalDate)),
            PartialPeriod(
        ...
        .withUsualHours(List(UsualHours("2020, 11, 28".toLocalDate, Hours(148.0)), UsualHours("2020, 12, 26".toLocalDate, Hours(15.86))))
        .withPartTimeHours(
          List(PartTimeHours("2020, 11, 28".toLocalDate, Hours(40.0)), PartTimeHours("2020, 12, 26".toLocalDate, Hours(1.86)))
        )
        -> 1831.11,
      emptyUserAnswers
