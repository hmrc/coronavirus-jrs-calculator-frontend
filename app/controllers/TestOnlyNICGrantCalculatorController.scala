...
import models.{Mode, PayPeriodBreakdown, PayPeriodWithPayDay, PaymentDate, Period, UserAnswers}
              ...
              val nic = handler.handleCalculation(
                ...
                List(
                  PayPeriodBreakdown(
                    ...
                    PayPeriodWithPayDay(Period(value.startDate, value.endDate), PaymentDate(value.payDate)))),
                NiRate()
