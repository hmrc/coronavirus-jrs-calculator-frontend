  ...
  "Navigator" when {
    ...
    "in Normal mode" must {
      ...
      "go to start of top up loop after top up periods page" in {
        ...
        val userAnswers = mandatoryAnswersOnRegularMontlhy.setValue(TopUpPeriodsPage, topUpPeriods)
      ...
      "go to start of additional payment loop after additional payment periods page" in {
        ...
        val userAnswers = mandatoryAnswersOnRegularMontlhy.setValue(AdditionalPaymentPeriodsPage, additionalPaymentDates)
