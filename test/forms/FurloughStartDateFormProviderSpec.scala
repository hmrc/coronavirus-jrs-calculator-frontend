...
class FurloughStartDateFormProviderSpec extends SpecBaseControllerSpecs {
  ...
  ".value" must {
    ...
    behave like dateFieldWithMin(form, "value", startDate, FormError("value", "furloughStartDate.error.minimum", "1 March 2020".toSeq))

    behave like dateFieldWithMax(form, "value", endDate, FormError("value", "furloughStartDate.error.maximum", "1 May 2020".toSeq))
